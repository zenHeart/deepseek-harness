...
- [npm <span class="citation" data-cites="deepseek-ai/dsh">@deepseek-ai/dsh</span>](https://www.npmjs.com/package/@deepseek-ai/dsh) — 支撑本章 `npx @deepseek-ai/dsh web` 安装运行方式与官方分发渠道（区别于 PyPI 同名混淆项目）。
