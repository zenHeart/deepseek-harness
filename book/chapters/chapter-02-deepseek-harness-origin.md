...
**第二个人对本书读者更加重要：史一凡**（Yifan Shi，GitHub ID：**Shigma**）——Cordis 上游生态（Koishi / cordiverse）的作者。如果你混过中文开源社区，大概率听说过 Koishi——一个基于插件框架的跨平台聊天机器人框架，经年累月积累了广泛的用户基础与数千个社区插件，核心思想就是"一切皆插件"。而 Cordis，正是 2022 年从 Koishi 项目中沉淀、抽象出来的通用插件框架（github.com/cordiverse/cordis）。史一凡后来加入 DeepSeek（2024 年已进入 DeepSeek-V3 技术报告作者名单），也是这篇时空可组合性论文的第一作者（论文由北京大学张玮组与 DeepSeek 联合署名，崔添翼为三作）。
